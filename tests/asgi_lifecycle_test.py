...
@pytest.mark.parametrize(
    ("fetch_timeout", "shutdown_timeout", "service_stop_timeout"),
    [
        pytest.param(25, 25, 45, id="drain-must-exceed-fetch"),
        pytest.param(20, 45, 45, id="drain-must-finish-before-service-stop"),
    ],
)
def test_asgi_factory_requires_ordered_shutdown_deadlines(
    ...
    settings.asgi.service_stop_timeout = service_stop_timeout
